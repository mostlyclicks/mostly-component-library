...
const SectionOne = () => {
  return (
    <div className="flex flex-col-reverse sm:flex-row mb-12">
      <div className="flex flex-wrap content-center p-12 sm:p-16 sm:pr-32 sm:h-96 w-full sm:w-2/3 lg:w-4/5 bg-gradient-to-r from-gray-700 to-gray-400 border-2 text-white">
